...
# Render, Railway, Fly.io, Koyeb va har qanday VPS uchun yagona konteyner
# ==============================================================================
...
# 1. Backend bog'liqliklarini o'rnatish
...
# 5. Ruxsatlar va uploads papkasi
RUN mkdir -p backend/uploads && chmod -R 777 backend/uploads
RUN chmod +x start.sh deploy.sh

# Render / Railway standarti: $PORT muhit o'zgaruvchisi orqali port boshqariladi
ENV PORT=3000
EXPOSE 3000
